...
A node for displaying and managing a specific inventory slot and its item
...
```bash
clone-gd-addon https://github.com/ChillCube/InventoryFrame2D.git
```

## Documentation
You can find the documentation at: https://github.com/ChillCube/InventoryFrame2D/blob/main/DOCUMENTATION.md

## Deinstallation
### Linux
Run this in the root of your godot project:
```bash
remove-gd-addon InventoryFrame2D
```
